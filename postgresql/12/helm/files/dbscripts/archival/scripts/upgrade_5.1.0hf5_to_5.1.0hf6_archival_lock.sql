create or replace FUNCTION OMS_Seed_ArchivalLock(IN EXPONENT int) returns void
LANGUAGE plpgsql
AS	$$
DECLARE
...
EXCEPTION WHEN OTHERS THEN
  	raise notice 'An error occurred while seeding archival lock';
