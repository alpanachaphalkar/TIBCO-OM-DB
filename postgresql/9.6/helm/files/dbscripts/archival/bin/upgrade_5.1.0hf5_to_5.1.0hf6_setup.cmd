...
psql -U %pg_archival_user% -d %pg_archival_database% -h %PG_HOST% -p %PGPORT% -v pg_tablespace=%pg_archival_tablespace% -f ./upgrade_5.1.0hf5_to_5.1.0hf6_archival_lock.sql
psql -U %pg_archival_user% -d %pg_archival_database% -h %PG_HOST% -p %PGPORT% -v pg_tablespace=%pg_archival_tablespace% -f ./upgrade_5.1.0hf5_to_5.1.0hf6_ddl.sql
